    ...
    <form name="form1" id= "form1" action="reporte_producto.php" method="post">
        <fieldset >
            ...
            <select id="year" name="year" >
                <option value="t">*Todos*</option>
                <option value="2008" <?php if ($year == '2008') {
        echo "selected";
    } ?>>2008</option>			
                <option value="2009" <?php if ($year == '2009') {
        echo "selected";
    } ?>>2009</option>			
                <option value="2010" <?php if ($year == '2010') {
        echo "selected";
    } ?>>2010</option>			
        ...
        echo "selected";
            ...
            <select id="ordenar" name="ordenar" >
                <option value="P" <?php if ($ordenar == 'P') {
        echo "selected";
    } ?>>Producto</option>			
                <option value="F" <?php if ($ordenar == 'F') {
        echo "selected";
    } ?>>Fecha</option>			
            </select><br>
