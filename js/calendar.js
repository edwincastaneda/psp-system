...
// tooltips
Calendar._TT = {};
Calendar._TT["TOGGLE"] = "Cambiar primer dia de la semana";
Calendar._TT["PREV_YEAR"] = "Año anterior (deje presionado para menu)";
Calendar._TT["PREV_MONTH"] = "Mes anterior (deje presionado para menu)";
Calendar._TT["GO_TODAY"] = "Ir al dia de hoy";
Calendar._TT["NEXT_MONTH"] = "Siguiente mes (deje presionado para menu)";
Calendar._TT["NEXT_YEAR"] = "Siguiente año (deje presionado para menu)";
Calendar._TT["SEL_DATE"] = "Seleccione fecha";
Calendar._TT["DRAG_TO_MOVE"] = "Arrastrar para mover";
Calendar._TT["PART_TODAY"] = " (hoy)";
Calendar._TT["MON_FIRST"] = "Mostrar Lunex primero";
...
function showCalendar(id,dateFormat,date_default) {
  ...
  if (calendar != null) {
	...
	if ( date_default )    
	{
		calendar.parseDate(date_default);
	}	
  }  
