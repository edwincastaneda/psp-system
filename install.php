...
<html lang="es">
    ...
    <script>
        function validar() {
            if (document.form1.host.value == '')
                alert('Debe Ingresar Servidor de Base de Datos');
            else if (document.form1.user_db.value == '')
                alert('Debe Ingresar Usuario Root');
            //else if (document.form1.password_db.value=='') alert('Debe Ingresar Password de Base de Datos');
            else if (document.form1.db_name.value == '')
                alert('Debe Ingresar Nombre de Base de Datos');
            else if (document.form1.user_ap.value == '')
                alert('Debe Ingresar Usuario de Aplicación');
            else if (document.form1.password_ap.value == '')
                alert('Debe Ingresar Password de Aplicación');
            else
